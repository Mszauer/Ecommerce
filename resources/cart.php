...
if(isset($_GET['add'])) {
  ...
  while($row = fetch_array($query)) {
    if($row['product_quantity'] >= $_SESSION['product_' . $_GET['add']]) {
      ...
      set_message("<div class=\"alert alert-success\">{$row['product_title']} successfully added to cart</div>");
      redirect("../public/checkout.php");
    } else {
      set_message("<div class=\"alert alert-danger\">{$row['product_title']} unable to be added to cart.</div>");
      redirect("../public/checkout.php");
    }
  }
  // $_SESSION['product_' . $_GET['add']] +=1;
...
if(isset($_GET['delete'])) { 
  ...
  unset($_SESSION['item_total']);
  unset($_SESSION['item_quantity']);
  set_message("<div class=\"alert alert-success\">Successfully removed from cart</div>");
  redirect("../public/checkout.php");
}
